        ...
        return ( 
           ...
           <div className="transbox">
            <form>
                ...
                <br></br><br></br>
                <label>Name: </label>
                <input type='text' id="productName" value={this.state.productName}  onChange={this.getName}  ></input>
               
                <br></br><br></br>
                <label>Price: </label>
                <input type='number' id="productPrice" value={this.state.productPrice}  onChange={this.getprice}></input>
             
                <br></br><br></br>
                <label>Description: </label>
                <input type='text' id="productDescription" value={this.state.productDescription}  onChange={this.getDescription} ></input>
               
                <br></br><br></br>
                <label>Stock: </label>
                <input type='number' id="productStock" value={this.state.productStock}  onChange={this.getStock} ></input>
               
                <br></br><br></br>
                <label>Category</label>
                <select name='category' id="productCategory" onChange={this.getCategory} >
